    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{url('design/user/img/carousel-bg-1.jpg')}});">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Edit Spare Part</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Edit Spare Part</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="mb-5">Edit Spare Part</h1>
            </div>
            <div class="row g-4">
                {!! Form::model($item, ['route' => ['workshop.spare_parts.update', $item->sparePartID], 'method' => 'put', 'files' => true, 'class' => '']) !!}
