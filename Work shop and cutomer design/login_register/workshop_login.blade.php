    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{url('design/user/img/carousel-bg-1.jpg')}});">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Workshop Login</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="{{route('site.home')}}">Home</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Workshop Login</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-primary text-uppercase">// Login Now //</h6>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <p class="mb-4">
                            write your email and your password to go to your account.</p>
                            @if ($errors->any())
                  ...
                  @endif
                        <form action="{{route('workshop.login.post')}}" method="post">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <p>Don't have an account ? <a href="{{route('workshop.register')}}">create one.</a></p>
                                </div>
